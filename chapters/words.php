    ...
    ?>
        <table class="table2 table-bordered" style="width: 100%;">
            <tbody id="wordList">
                ...
                ?>
                    <tr>
                        <td><span class="leftSide"><i id="from" class="fas fa-volume-up"></i><input type="text" name="lword" data-id="" value="<?php echo $result[$k][$mlang]; ?>"></span> :
                            <span class="rightSide"><i id="from" class="fas fa-volume-up"></i><input type="text" name="rword" data-id="" value="<?php echo $result[$k][$lLang]; ?>"></span>
                        </td>
                    </tr>
            <?php
                }
